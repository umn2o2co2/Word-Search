...
char matrix1[4][4];
char word[3];
void locate(char word[3]);
int find(int point_i,int point_j,int letter_count,char word[3]);
...
int find(int i,int j,int letter_count,char word[3])
{
